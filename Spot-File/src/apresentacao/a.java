...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		case 1: // BUSCAR ARTISTA
			...
			// PRINTANDO ÁLBUNS DE ACORDO COM O TOTAL DE ÁLBUNS CRIADOS DO ARTISTA
			// SELECIONADO
			int escolhaAlbum;
			// maior que 5
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		case 2: // BUSCAR OUVINTE
			System.out.println("Insira o nome do ouvinte que procuras:"); 
			...
			if(ouvintesPuxados.isEmpty()) {
				System.out.println("Não existe ouvinte com esse nome! Verifique se o nome está correto e tente novamente ;) ."); 
				break;
			}
			Ouvinte ouvinteProcurado = ouvintesPuxados.get(0);  
			
			if(ouvinteProcurado.getPlaylists().size()<5) {
				//printa as 5 primeiras playlists
				System.out.println("========PLAYLISTS DE "+ ouvinteProcurado.getNome()+"========");
				for(int i =0; i<5; i++) {
					System.out.println(i+1 +")");
					System.out.println(ouvinteProcurado.getPlaylists().get(i).getNome()); 
					System.out.println(ouvinteProcurado.getPlaylists().get(i).getFotoDaCapaURL()); 
				}
				System.out.println("===========================");
				//pergunta
				...
				if(showAll.equals("S")) {
					System.out.println("========PLAYLISTS DE "+ ouvinteProcurado.getNome()+"========");
					for(int i =0; i<ouvinteProcurado.getPlaylists().size(); i++) {
						System.out.println(i+1 +")");
						System.out.println(ouvinteProcurado.getPlaylists().get(i).getNome()); 
						System.out.println(ouvinteProcurado.getPlaylists().get(i).getFotoDaCapaURL()); 
					}
				...
				System.out.println("Escolha uma playlist pelo número indicado:"); 
				int escolhaPlaylist = scanner.nextInt(); 
				scanner.nextLine(); 
				Playlist playlistEscolhida = ouvinteProcurado.getPlaylists().get(escolhaPlaylist-1); 
				
				acoesPlaylist(ouvinteProcurado, playlistEscolhida);
				
				
				
				/*// mostra músicas da playlits
				for(int i =0; i<playlistEscolhida.getMusicas().size(); i++) {
					System.out.println(i+1 +")");
					System.out.println(playlistEscolhida.getMusicas().get(i).getNome());
					System.out.println(playlistEscolhida.getMusicas().get(i).getDuracaoMusica());
					System.out.println(albumDAO.buscarPorId(playlistEscolhida.getMusicas().get(i).getIdAlbum()).getNome());
					System.out.println(artistaDAO.buscarPorIdArtista(albumDAO.buscarPorId(playlistEscolhida.getMusicas().get(i).getIdAlbum()).getIdArtista()).getNome());
				}
				
				////////////////////////////////////////////////////////////////////////////////////
				//ações playlist
				System.out.println("Digite o número indicado para:");
				System.out.println("1)Salvar playlist");
				System.out.println("2)Salvar música em playlist");
				System.out.println("3)Seguir ouvinte"); 
				System.out.println("4)Ver álbum de música"); 
				System.out.println("5)Ver artista de música"); 
				System.out.println("0)Voltar"); 
				int escolhaAcaoPlaylist = scanner.nextInt();
				scanner.nextLine(); 
				do {
				switch(escolhaAcaoPlaylist) {
				case 1: 
			...
			}else if (ouvinteProcurado.getPlaylists().size()==5) {
				System.out.println("========PLAYLISTS DE "+ ouvinteProcurado.getNome()+"========");
				for(int i =0; i<ouvinteProcurado.getPlaylists().size(); i++) {
					System.out.println(i+1 +")");
					System.out.println(ouvinteProcurado.getPlaylists().get(i).getNome()); 
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		case 3: // BUSCAR MÚSICA
			System.out.println("Insira o nome da música que procuras:"); 
			String nomeMusicaProcurada = scanner.nextLine(); 
			List<Musica> musicasPuxadas = musicaDAO.buscarListaMusicaPorNome(nomeMusicaProcurada); 
			if(musicasPuxadas.isEmpty()) {
				System.out.println("Não existe música com esse nome! Verifique se o nome está correto e tente novamente ;) ."); 
				break;
			}
			Musica musicaProcurada = musicasPuxadas.get(0); 
			Album albumDaMusica = albumDAO.buscarPorId(musicaProcurada.getIdAlbum()); 
			Artista artistaCriadorMusica = artistaDAO.buscarPorIdArtista(albumDaMusica.getIdArtista()); 
			
			System.out.println("Artista criador: " + artistaCriadorMusica.getNome()); 
			System.out.println("Álbum da música: " + albumDaMusica.getNome());
			System.out.println("Visualizar álbum? (S/N)"); 
			String escolhaVisualizarAlbum = scanner.nextLine(); 
			//printa album se assim o ouvinte quiser
			if(escolhaVisualizarAlbum.equals("S")) {
				for (int i =0; i<albumDaMusica.getMusicas().size(); i++) {
					//vê se a música printada é a música procurada
					if (albumDaMusica.getMusicas().get(i).getNome().equals(musicaProcurada.getNome())) {
						System.out.println("A música que procuravas:"); 
					}
					System.out.println(albumDaMusica.getMusicas().get(i).getNome()); 
					System.out.println(albumDaMusica.getMusicas().get(i).getDuracaoMusica());
				}
			}
			acoesMusica(musicaProcurada, albumDaMusica, artistaCriadorMusica);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		case 4: // BUSCAR ÁLBUM
			...
			System.out.println("Artista criador: " + artistaCriador.getNome()); //aqui ta dando erro e printando umas coisas tipo model.artista2546205482w
			...
			do {
				...
				if (bibliotecaOuvinte.isEmpty() || bibliotecaOuvinte == null) { // testa se não é vazia
					...
					if (bibliotecaOuvinte.size() <= 5) {
						...
						System.out.println("\n---------------------------");
						System.out.println("\n  1) Ver Playlist Completa");
						System.out.println("  0) Voltar");
						int optionBiblioteca = scanner.nextInt();
						scanner.nextLine();
						switch (optionBiblioteca) {
						case 1:
							System.out.println("Digite o nome da playlist que deseja vizualizar: ");
							Playlist playlistSelecionada = playlistDAO.buscarListaPlaylistPorNome(scanner.next())
									.get(0); // procura
												// a
												// playlist
												// digitada
							...
							System.out.println("Vizualizar a Playlist " + playlistSelecionada.getNome() + "?(S/N)");
							String confirmacaoVizualizar = scanner.next();
							scanner.nextLine();
							confirmacaoVizualizar.toUpperCase();
							acoesPlaylist(playlistSelecionada, confirmacaoVizualizar);
							break;
						case 0:
							opcaoVoltarBiblioteca = 0;
							break;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		case 7: // LISTAR SEGUIDORES
			...
			break;
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		case 8: // LISTAR SEGUINDOS escobar fez
			menuOuvinte();
			break;
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		case 10: // ATUALIZAR PLAYLIST & add musica
			...
			break;
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		case 11: // DELETAR PLAYLIST escobar fez
			menuOuvinte();
			break;
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		case 12: // DELETAR PERFIL escobar fez
			menuOuvinte();
			break;
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		case 0:
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public static void acoesAlbum(Artista artistaProcurado, int escolhaAlbum) {
		System.out.println("Digite o número indicado para:");
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		case 2: // salvando musica em playlist
			...
			escolhaMusica = scanner.nextInt();
			Musica musicaEscolhida = artistaProcurado.getAlbuns().get(escolhaAlbum - 1).getMusicas()
					.get(escolhaMusica - 1);
			scanner.nextLine();
			if (escolhaMusica == 0) {
				System.out.println("Voltando...");
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		case 1: // salvando album
			...
			List<Musica> musicasAlbumSalvo = new ArrayList<Musica>(); 
			for(int i = 0; i<albumProcurado.getMusicas().size(); i++) {
				musicasAlbumSalvo.add(albumProcurado.getMusicas().get(i)); //dando erro
			}
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////
	public static void acoesMusica(Musica musicaProcurada, Album albumDaMusica, Artista artistaCriador) {
		System.out.println("Digite o número indicado para:");
		System.out.println("1)Salvar álbum da música:");
		System.out.println("2)Salvar música em playlist");
		System.out.println("3)Seguir artista");
		System.out.println("0)Voltar");
		int escolhaDentroDeMusica = scanner.nextInt();
		scanner.nextLine();

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

		switch (escolhaDentroDeMusica) {
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

		case 1: // salvando album
			System.out.println("Salvando álbum, " + albumDaMusica.getNome());

			Playlist albumSalvo = new Playlist();

			// pega diretamente as músicas do álbum original (sem recriar)
			List<Musica> musicasAlbumSalvo = new ArrayList<Musica>(
					albumDaMusica.getMusicas());

			albumSalvo.setNome(albumDaMusica.getNome());
			albumSalvo.setFotoDaCapaURL(albumDaMusica.getFotoDaCapaURL());
			albumSalvo.setTempoStreaming(albumDaMusica.getTempoStreaming());
			albumSalvo.setIdOuvinte(ouvinteLogado.getIdOuvinte());
			albumSalvo.setMusicas(musicasAlbumSalvo);
			// salva no bd
			try {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			case 3: // criar nova playlist
				Playlist playlist = new Playlist();
				playlist.setNome(musicaProcurada.getNome());
				List<Musica> musicaPlaylist = new ArrayList<Musica>();
				musicaPlaylist.add(musicaProcurada);
				playlist.setMusicas(musicaPlaylist);
				playlist.setIdOuvinte(ouvinteLogado.getIdOuvinte());
				playlist.setTempoStreaming(musicaProcurada.getDuracaoMusica());
				playlist.setFotoDaCapaURL(albumDAO.buscarPorId(musicaProcurada.getIdAlbum()).getFotoDaCapaURL());
			...
			if (indicacaoDeBusca != 3) {
				System.out.println("Salvando música, " + musicaProcurada.getNome() + ", na playlist "
						+ playlistProcurada.getNome());

				playlistProcurada.getMusicas().add(musicaProcurada);
				// salva no bd
				try {
					playlistDAO.adicionarMusica(musicaProcurada, playlistProcurada);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public static void acoesPlaylist(Playlist playlistSelecionada, String confirmacaoVizualizar) {

		if (confirmacaoVizualizar.matches("S")) {
			int opcaoVoltarVizualizacao = 1;
			do {
				System.out.println("--- " + playlistSelecionada.getNome() + " ---"); // vizualiação de
																						// playlist
				playlistSelecionada.printarInfos();

				for (Musica musica : playlistSelecionada.getMusicas()) {// mostra as músicas com o nome
				...
				for (int i = 0; i < playlistSelecionada.getNome().length(); i++) {
					tamanhoNomePlaylist += "-";
				}
				System.out.println("\n--- " + tamanhoNomePlaylist + " ---");

				// opcoes na playlist
				System.out.println("1) Editar Playlist");
				System.out.println("2) Deletar Playlist");
				System.out.println("3) Remover Música");
				System.out.println("0) Voltar");

				int optionPlaylistSelecionada = scanner.nextInt();
				scanner.nextLine();

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

				switch (optionPlaylistSelecionada) {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				...
				case 1:
					...
					System.out.println("0) Voltar");
					int optionEdicaoPlaylist = scanner.nextInt();
					scanner.nextLine();
					switch (optionEdicaoPlaylist) {
					case 1:
						System.out.println("Nome atual: " + playlistSelecionada.getNome());
						System.out.println("Nome novo: ");
						String nomeNovo = scanner.next();
						scanner.nextLine();
						playlistSelecionada.setNome(nomeNovo);// altera nome e manda para o bd
						playlistDAO.editar(playlistSelecionada);
						break;
					case 2:
						System.out.println("Bio atual: " + playlistSelecionada.getBio());
						System.out.println("Bio nova: ");
						String bioNova = scanner.next();
						scanner.nextLine();
						playlistSelecionada.setBio(bioNova);// altera bio e manda para o bd
						playlistDAO.editar(playlistSelecionada);
						break;
					case 3:
						System.out.println("Foto atual: " + playlistSelecionada.getFotoDaCapaURL());
						System.out.println("Foto nova: ");
						String fotoNova = scanner.next();
						scanner.nextLine();
						playlistSelecionada.setFotoDaCapaURL(fotoNova);// altera foto no bd
						playlistDAO.editar(playlistSelecionada);
						break;
					case 0:
						System.out.println("Voltando...");
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				...
				case 2:
					System.out.println("=== EXCLUIR PLAYLIST ===");
					System.out.println("Ao deletar a playlist, esse mix único que nem você se perderá!");
					System.out.println("Você tem certeza que deseja deletar essa playlist?(S/N)");
					String confirmacaoDeletePlaylist = scanner.next();
					scanner.nextLine();
					if (confirmacaoDeletePlaylist.matches("S")) {// testa a confirmacao
						System.out.println("Deletando Playlist...");
						System.out.println("(adeus querida " + playlistSelecionada.getNome() + ")");
						playlistDAO.excluirPorId(playlistSelecionada);// exlui no bd
						System.out.println("Exclusão Concluída!");
						System.out.println("Voltando à Biblioteca...");
						opcaoVoltarVizualizacao = 0;// volta à biblioteca
						break;
					} else if (confirmacaoDeletePlaylist.matches("N")) {
						System.out.println("Tudo bem!\nExclusão cancelada");
						System.out.println("Voltando à Playlist...");// volta à playlist
					} else {
						System.out.println("Opção Inválida");
						System.out.println("Voltando à Playlist...");
					}
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				...
				case 3:
					...
					System.out.println("Digite o nome da música que quer remover: ");
					String nomeProcurado = scanner.next();
					scanner.nextLine();
					// encontra a música no bd
					Musica musicaSelecionada = musicaDAO
							.buscarListaMusicaPorNomeEIdPlaylist(nomeProcurado, playlistSelecionada.getIdPlaylist())
							.get(0);
					System.out.println("Deseja remover a Música '" + musicaSelecionada.getNome() + "' de "
							+ playlistSelecionada.getNome() + "?(S/N)");
					String confirmacaoDeleteMusicaPlaylist = scanner.next();
					scanner.nextLine();
					// teste para remoção de música no bd
					if (confirmacaoDeleteMusicaPlaylist.matches("S")) {
						System.out.println("Removendo...");
						System.out.println("Sucesso!");
						playlistDAO.removerMusica(musicaSelecionada, playlistSelecionada);
					} else if (confirmacaoDeleteMusicaPlaylist.matches("N")) {
						System.out.println("Remoção Cancelada!");
						System.out.println("Voltando à playlist...");
					} else {
						System.out.println("Ei ei! 'S' para Sim, 'N' para Não. O que você esperava com: "
								+ confirmacaoDeleteMusicaPlaylist + "?");
						System.out.println("Voltando à Playlist...");
					}
					break;
				case 0:
		...
		} else if (confirmacaoVizualizar.matches("N")) {
			System.out.println("Voltando à Biblioteca...");
			return;
		} else {
			System.out.println(
					"Ei ei! 'S' para Sim, 'N' para Não. O que você esperava com: " + confirmacaoVizualizar + "?");
			System.out.println("Voltando à Biblioteca...");
			return;
		}
	}
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
public static void acoesPlaylist(Ouvinte ouvinteProcurado, Playlist playlistEscolhida) {
    int escolhaAcaoPlaylist;

    do {
        System.out.println("\n======= MÚSICAS DA PLAYLIST " + playlistEscolhida.getNome() + " =======");
        for (int i = 0; i < playlistEscolhida.getMusicas().size(); i++) {
            Musica musica = playlistEscolhida.getMusicas().get(i);
            Album album = albumDAO.buscarPorId(musica.getIdAlbum());
            Artista artista = artistaDAO.buscarPorIdArtista(album.getIdArtista());

            System.out.println((i + 1) + ") " + musica.getNome());
            System.out.println("Duração: " + musica.getDuracaoMusica());
        ...
        escolhaAcaoPlaylist = scanner.nextInt();
        scanner.nextLine();

        switch (escolhaAcaoPlaylist) {
            case 1:
            	System.out.println("Salvando playlist, " + playlistEscolhida.getNome()); 
            	
            	Playlist playlistSalva = new Playlist(); 
            	
            	List<Musica> musicasPlaylistSalva = new ArrayList<Musica>(); 
    			for(int i = 0; i<playlistEscolhida.getMusicas().size(); i++) {
    				musicasPlaylistSalva.add(playlistEscolhida.getMusicas().get(i)); //dando erro
    			}
    			
    			playlistSalva.setNome(playlistEscolhida.getNome());
    			playlistSalva.setFotoDaCapaURL(playlistEscolhida.getFotoDaCapaURL());
    			playlistSalva.setTempoStreaming(playlistEscolhida.getTempoStreaming());
    			playlistSalva.setIdOuvinte(ouvinteLogado.getIdOuvinte());
    			playlistSalva.setMusicas(musicasPlaylistSalva);
    			// salva no bd
    			try {
    				playlistDAO.salvar(playlistSalva); // salva a playlist em si

    				System.out.println("Playlist salva com sucesso!");
    			} catch (Exception e) {
    				System.out.println("Erro ao salva playlist: " + e.getMessage());
    			}
    			// ATUALIZA MEMÓRIA
    			ouvinteLogado = ouvinteDAO.buscarPorIdOuvinte(ouvinteLogado.getIdOuvinte());
                ...
                break;
            case 2:
                System.out.println("Escolha a música para salvar em outra playlist:");
                // Aqui você pode listar as músicas novamente e fazer o usuário escolher uma.
                break;
            case 3:
                System.out.println("Seguindo ouvinte " + ouvinteProcurado.getNome());
                break;
            case 4:
                System.out.println("Visualizando álbum...");
                break;
            case 5:
                System.out.println("Visualizando artista...");
                break;
            case 0:
                System.out.println("Voltando ao menu...");
                menuOuvinte(); 
